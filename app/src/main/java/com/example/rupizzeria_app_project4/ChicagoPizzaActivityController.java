...
public class ChicagoPizzaActivityController extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pizzaTypeChanged(findViewById(R.id.spinner_chicagoPizzaType));
    ...
    private void addToCartClicked(View view) {
        ...
        addToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PizzaFactory pizzaFactory = new Core.ChicagoPizza();
                ...
                if (getPizzaTypeFromSpinner().equals(getString(R.string.chicago_deluxe))) {
                    ...
                    showPizzaAddedToast();
                } else if (getPizzaTypeFromSpinner().equals(getString(R.string.chicago_meatzza))) {
                    Pizza meatzza = pizzaFactory.createMeatzza();
                    meatzza.setSize(pizzaSize);
                    currentOrder.add(meatzza);
                    showPizzaAddedToast();
                } else if (getPizzaTypeFromSpinner().equals(getString(R.string.chicago_buildyourown))) {
    ...
    public void pizzaTypeChanged(View view) {
        ...
        pizzaType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (selectedPizza.equals(getString(R.string.chicago_deluxe))) {
                    //change the crust to Deep Dish
                    crustType.setText(getString(R.string.crust_DeepDish));
                    //change the image
                    pizzaImage.setImageResource(R.drawable.chicagostyle_deluxe);
                    deluxePizzaSelectionsOnly();
                } else if (selectedPizza.equals(getString(R.string.chicago_bbq))) {
                    //change the crust to pan
                    crustType.setText(getString(R.string.crust_Pan));
                    //change the image
                    pizzaImage.setImageResource(R.drawable.chicagostyle_bbqchicken);
                    bbqChickenPizzaSelectionsOnly();
                } else if (selectedPizza.equals(getString(R.string.chicago_meatzza))) {
                    //change the crust to stuffed
                    crustType.setText(getString(R.string.crust_Stuffed));
                    //change the image
                    pizzaImage.setImageResource(R.drawable.chicagostyle_meatzza);
                    meatzzaPizzaSelectionsOnly();
                } else if (selectedPizza.equals(getString(R.string.chicago_buildyourown))) {
                    //change the crust to Pan
                    crustType.setText(getString(R.string.crust_Pan));
                    //change the image
                    pizzaImage.setImageResource(R.drawable.chicagostyle_buildyourown);
    ...
    public void pizzaSizeChanged(View view) {
        ...
        pizzaSize.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                String selectedPizza = ((Spinner) findViewById(R.id.spinner_chicagoPizzaType))
                ...
                if (selectedSize.equals(getString(R.string.pizzaSize_small))) {
                    currentBasePrice = selectedPizza.equals(getString(R.string.chicago_buildyourown))
